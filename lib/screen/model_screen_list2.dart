...
abstract class ModelScreenList2<T extends IModel> extends ModelSinglePage<T>
    with UiLoggy {
  final Widget? drawer;
  final String? title;
  final String? parentId;
  ModelScreenList2({super.key, super.enableSplit = true, this.drawer, this.title, this.parentId});
