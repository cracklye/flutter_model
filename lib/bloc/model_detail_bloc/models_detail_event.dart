...
class ModelsDetailLoad<T extends IModel> extends ModelsDetailEvent<T> {
  ...
  const ModelsDetailLoad({this.id});
}
...
class ModelsDetailDelete<T extends IModel> extends ModelsDetailEvent<T> {
  ...
  const ModelsDetailDelete(this.id);
}
...
class ModelDetailRaiseError<T extends IModel> extends ModelsDetailEvent<T> {
  final String message;
  const ModelDetailRaiseError(this.message);
}
