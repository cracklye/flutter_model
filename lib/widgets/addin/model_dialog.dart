...
//                     padding: const EdgeInsets.all(12.0),
//                     child: SingleChildScrollView(
//                       child: BlocConsumer<ModelEditViewBloc<T>, ModelEditViewState<T>>(
//                           listener: (context, state) {
//                         // print("Listener has been called $state");

//                         if (state is ModelEditViewStateSaved<T>) {
...
//                                 BlocProvider.of<ModelEditViewBloc<T>>(context).add(
...
//                                 BlocProvider.of<ModelEditViewBloc<T>>(context).add(
//                                   ModelEditViewEventSave<T>(values, parentId: parentId),
//                                 );
//                               }
//                             }, parentId),
